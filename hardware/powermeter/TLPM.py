...
class TLPM:
	...
	def __init__(self):
		if sizeof(c_voidp) == 4: self.dll = cdll.LoadLibrary("C:\Program Files\IVI Foundation\VISA\Win64\Bin\TLPM_32.dll")
		else: self.dll = cdll.LoadLibrary("C:\Program Files\IVI Foundation\VISA\Win64\Bin\TLPM_64.dll")
